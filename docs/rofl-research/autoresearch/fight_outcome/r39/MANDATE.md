...
## Mandate
passRate lift via failing-window audits (S0 2/6→↑; no S1 regress)
...
Write `researcher_r39_summary.json` + NOTES.md under fight_outcome/r39/ (mirror docs to parent path OK).
