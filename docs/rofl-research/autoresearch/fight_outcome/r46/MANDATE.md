...
## Mandate
finish-window / density passBand to lift fightPassRate toward 0.95
...
Write `researcher_r46_summary.json` + NOTES.md under fight_outcome/r46/ (mirror docs to parent path OK).
