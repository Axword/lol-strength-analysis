# r41 — galio-full-letherr

**Worktree:** `/Users/river/.codex/worktrees/rofl-fo-r41`  
**Branch:** `adv/fo-r41-galio-full-letherr`  
**never_edited_parent_code:** true  
**FA ≠ odds / pBlue%**

## Mandate
Galio c1 full |lethErr| 1.84→≤0.75 S1-safe (W residual)
...
Write `researcher_r41_summary.json` + NOTES.md under fight_outcome/r41/ (mirror docs to parent path OK).
